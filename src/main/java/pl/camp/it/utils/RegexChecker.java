...
public class RegexChecker {
    private final String loginRegex = "^[A-Za-z0-9]{3,15}";
    private final String passRegex = "^[A-Za-z0-9_@.\\/#&*+-]{5,15}$";
    private final String restaurantNameRegex = "^[A-Za-z0-9]{1,30}";
    private final String restaurantAdressRegex = "^[A-Za-z0-9]{3,15}[A-Za-z0-9_@./#&+-]{0,10}$";
    private final String restaurantCityRegex = "^[A-Za-z]{3,15}$";
    private final String restaurantCuisineRegex = "^[A-Za-z]{3,20}$";
    private final String nameSurnameRegex ="^[A-Za-z]{3,15}";
    private final String descriptionRegex = "^[A-Za-z0-9_@.\\/#&*+-.\\s]{5,150}$";
